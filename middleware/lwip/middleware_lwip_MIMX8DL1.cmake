if(NOT MIDDLEWARE_LWIP_MIMX8DL1_INCLUDED)
    
    set(MIDDLEWARE_LWIP_MIMX8DL1_INCLUDED true CACHE BOOL "middleware_lwip component is included.")
    ...
    #OR Logic component
    if(CONFIG_USE_middleware_lwip_empty_ethernetif_MIMX8DL1)
         include(middleware_lwip_empty_ethernetif_MIMX8DL1)
    endif()
    if(CONFIG_USE_middleware_lwip_usb_ethernetif_MIMX8DL1)
         include(middleware_lwip_usb_ethernetif_MIMX8DL1)
    endif()
    if(CONFIG_USE_middleware_lwip_enet_ethernetif_MIMX8DL1)
         include(middleware_lwip_enet_ethernetif_MIMX8DL1)
    endif()
    if(NOT (CONFIG_USE_middleware_lwip_empty_ethernetif_MIMX8DL1 OR CONFIG_USE_middleware_lwip_usb_ethernetif_MIMX8DL1 OR CONFIG_USE_middleware_lwip_enet_ethernetif_MIMX8DL1))
        message(WARNING "Since middleware_lwip_empty_ethernetif_MIMX8DL1/middleware_lwip_usb_ethernetif_MIMX8DL1/middleware_lwip_enet_ethernetif_MIMX8DL1 is not included at first or config in config.cmake file, use middleware_lwip_empty_ethernetif_MIMX8DL1 by default.")
        include(middleware_lwip_empty_ethernetif_MIMX8DL1)
    endif()
