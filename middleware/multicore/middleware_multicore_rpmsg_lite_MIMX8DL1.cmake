if(NOT MIDDLEWARE_MULTICORE_RPMSG_LITE_MIMX8DL1_INCLUDED)
    
    set(MIDDLEWARE_MULTICORE_RPMSG_LITE_MIMX8DL1_INCLUDED true CACHE BOOL "middleware_multicore_rpmsg_lite component is included.")
    ...
    elseif(CONFIG_USE_middleware_freertos-kernel_MIMX8DL1)
    target_sources(${MCUX_SDK_PROJECT_NAME} PRIVATE
        ...
        message(WARNING "please config middleware.baremetal_MIMX8DL1 or middleware.freertos-kernel_MIMX8DL1 first.")
    endif()
