...
#define APP_M4_MU_NVIC_IRQn IRQSTEER_2_IRQn
 ...
 *
 * LSIO_MU_IRQn min = LSIO_MU0_INT_IRQn = 169
 * LSIO_MU_IRQn max = LSIO_MU13_INT_B_IRQn = 191
 *
 * With all the LSIO MUs, the NVIC_IRQn = 34, that corresponds to IRQSTEER_2_IRQn
 */
