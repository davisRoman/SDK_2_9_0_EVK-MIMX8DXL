...
#if (defined(HAL_UART_ADAPTER_FIFO) && (HAL_UART_ADAPTER_FIFO > 0u))
#if defined(FSL_FEATURE_LPUART_HAS_FIFO) && FSL_FEATURE_LPUART_HAS_FIFO
    lpuartConfig.txFifoWatermark = FSL_FEATURE_LPUART_FIFO_SIZEn(s_LpuartAdapterBase[config->instance]) - 1U;
    lpuartConfig.rxFifoWatermark = FSL_FEATURE_LPUART_FIFO_SIZEn(s_LpuartAdapterBase[config->instance]) - 1U;
#endif
#endif
