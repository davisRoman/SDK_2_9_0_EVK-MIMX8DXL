...
- pin_list:
  ...
  - {pin_num: AR11, peripheral: LSIO__QSPI_A, signal: 'qspi_a_data, 0', pin_signal: QSPI0A_DATA0, sw_config: sw_config_0}
  - {pin_num: AN13, peripheral: LSIO__QSPI_A, signal: 'qspi_a_data, 1', pin_signal: QSPI0A_DATA1, sw_config: sw_config_0}
  - {pin_num: AN9, peripheral: LSIO__QSPI_A, signal: 'qspi_a_data, 2', pin_signal: QSPI0A_DATA2, sw_config: sw_config_0}
  - {pin_num: AN11, peripheral: LSIO__QSPI_A, signal: 'qspi_a_data, 3', pin_signal: QSPI0A_DATA3, sw_config: sw_config_0}
  - {pin_num: AP8, peripheral: LSIO__QSPI_A, signal: qspi_a_sclk, pin_signal: QSPI0A_SCLK, sw_config: sw_config_0, PDRV: PDRV_0}
  - {pin_num: AN7, peripheral: LSIO__QSPI_A, signal: qspi_a_ss0_b, pin_signal: QSPI0A_SS0_B, sw_config: sw_config_0, PDRV: PDRV_0}
  - {pin_num: AP10, peripheral: LSIO__QSPI_B, signal: 'qspi_b_data, 0', pin_signal: QSPI0B_DATA0, sw_config: sw_config_0}
  - {pin_num: AP12, peripheral: LSIO__QSPI_B, signal: 'qspi_b_data, 1', pin_signal: QSPI0B_DATA1, sw_config: sw_config_0}
  - {pin_num: AR13, peripheral: LSIO__QSPI_B, signal: 'qspi_b_data, 2', pin_signal: QSPI0B_DATA2, sw_config: sw_config_0}
  - {pin_num: AP14, peripheral: LSIO__QSPI_B, signal: 'qspi_b_data, 3', pin_signal: QSPI0B_DATA3, sw_config: sw_config_0}
  - {pin_num: AR9, peripheral: LSIO__QSPI_A, signal: qspi_a_dqs, pin_signal: QSPI0A_DQS, sw_config: sw_config_0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(sc_ipc_t ipc)                          /*!< Function assigned for the core: Cortex-M4F[m4] */
{
  ...
  err = sc_pad_set_all(ipc, BOARD_INITPINS_QSPI0_DQS_PIN_FUNCTION_ID, 0U, SC_PAD_CONFIG_NORMAL, SC_PAD_ISO_OFF, 0x0 ,SC_PAD_WAKEUP_OFF);/* IOMUXD_QSPI0A_DQS register modification value */
  if (SC_ERR_NONE != err)
  {
      assert(false);
  }
