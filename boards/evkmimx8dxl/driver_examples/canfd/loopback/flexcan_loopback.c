 ...
 * If other frequency wanted, please use CLK_SRC=0 and set the working frequency for CAN2.
 */
...
#define EXAMPLE_FLEXCAN_IRQn       ADMA_FLEXCAN2_INT_IRQn
#define EXAMPLE_FLEXCAN_IRQHandler ADMA_FLEXCAN2_INT_IRQHandler
/*
