...
Board settings
==============
The Multicore RPMsg-Lite string echo RTOS project does not call for any special hardware configurations.
...
3.  Open 2 serial terminals with the following settings:
    ...
    - One stop bit
    - No flow control
4.  One terminal is for A35, the other is for M4. Refer to Getting Started with MCUXpresso SDK for i.MX 8DualXLite(Doc No.: MCUXSDKIMX8DXLGSUG) for more COM port information.
...
8.  Using "modprobe imx_rpmsg_tty" to install kernel module in Linux side to kick off the demo
