...
#define GPT_CLOCKS                                                                                    \
    {                                                                                                 \
        kCLOCK_AUDIO_Gpt0, kCLOCK_AUDIO_Gpt1, kCLOCK_AUDIO_Gpt2, kCLOCK_AUDIO_Gpt3, kCLOCK_LSIO_Gpt0, \
            kCLOCK_LSIO_Gpt1, kCLOCK_LSIO_Gpt2, kCLOCK_LSIO_Gpt3, kCLOCK_LSIO_Gpt4,                   \
    }
/*! @brief Clock ip name array for FLEXCAN.CAN1/CAN2 share the clock from CAN0 */
...
typedef enum _clock_ip_name
{
    ...
    kCLOCK_AUDIO_Gpt4           = LPCG_TUPLE(SC_R_GPT_9, NV),
    kCLOCK_AUDIO_Gpt5           = LPCG_TUPLE(SC_R_GPT_10, NV),
    ...
    kCLOCK_ADMA_Lcd0            = LPCG_TUPLE(SC_R_LCD_0, NV),
    ...
    kCLOCK_AUDIO_Sai4           = LPCG_TUPLE(SC_R_SAI_4, NV),
    kCLOCK_AUDIO_Sai5           = LPCG_TUPLE(SC_R_SAI_5, NV),
    kCLOCK_AUDIO_Esai0          = LPCG_TUPLE(SC_R_ESAI_0, NV),
    ...
    kCLOCK_DiMiPiDsiLvds0Lpi2c0 = LPCG_TUPLE(SC_R_MIPI_0_I2C_0, NV),
    kCLOCK_DiMiPiDsiLvds0Lpi2c1 = LPCG_TUPLE(SC_R_MIPI_0_I2C_1, NV),
    kCLOCK_DiMiPiDsiLvds1Lpi2c0 = LPCG_TUPLE(SC_R_MIPI_1_I2C_0, NV),
    kCLOCK_DiMiPiDsiLvds1Lpi2c1 = LPCG_TUPLE(SC_R_MIPI_1_I2C_1, NV),
    ...
    kCLOCK_Dpu0                 = LPCG_TUPLE(SC_R_DC_0, NV),
    ...
    kCLOCK_CONNECTIVITY_Enet1   = LPCG_TUPLE(SC_R_ENET_1, CONNECTIVITY__LPCG_ENET_QOS_BASE),
