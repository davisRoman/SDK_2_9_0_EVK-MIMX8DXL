...
#ifndef _MIMX8DL1_cm4_FEATURES_H_
#define _MIMX8DL1_cm4_FEATURES_H_
...
#define FSL_FEATURE_SOC_ASMC_COUNT (2)
...
#define FSL_FEATURE_SOC_PWM_COUNT (9)
...
#define FSL_FEATURE_SOC_USBDCD_COUNT (2)
...
#define FSL_FEATURE_EDMA_INSTANCE_CHANNELn(x) \
    (((x) == ADMA__EDMA0) ? (32) : (((x) == ADMA__EDMA2) ? (32) : (((x) == ADMA__EDMA3) ? (16) : (-1))))
    ...
    (((x) == SCU__LPUART) ?                  \
         ...
         (((x) == CM4__LPUART) ?             \
              ...
              (((x) == ADMA__LPUART0) ?      \
                   ...
                   (((x) == ADMA__LPUART1) ? \
                        (64) :               \
                        (((x) == ADMA__LPUART2) ? (64) : (((x) == ADMA__LPUART3) ? (64) : (-1)))))))
...
#define FSL_FEATURE_INTMUX_IRQ_START_INDEX (445)
    ...
    (((x) == SCU__LPI2C) ?                         \
         ...
         (((x) == CM4__LPI2C) ?                    \
              ...
              (((x) == ADMA__LPI2C0) ?             \
                   (16) :                          \
                   (((x) == ADMA__LPI2C1) ? (16) : \
                                            (((x) == ADMA__LPI2C2) ? (16) : (((x) == ADMA__LPI2C3) ? (16) : (-1)))))))
...
#define FSL_FEATURE_IRQSTEER_CHn_MASK_COUNT (12)
...
#define FSL_FEATURE_IRQSTEER_MASTER_COUNT (6)
...
#endif /* _MIMX8DL1_cm4_FEATURES_H_ */
